...
ONLINE_CASES = (
    OnlineCaseExpectation(
        ...
        required_trace_tools=("route.plan", "provider.geocode", "provider.map.route"),
        route_max_km=20,
    ),
    OnlineCaseExpectation(
    ...
    OnlineCaseExpectation(
        ...
        expected_safety="SAFE",
        expected_status="EXECUTED",
        forbidden_trace_tools=("route.plan", "provider.map.route"),
    ),
    OnlineCaseExpectation(
        content="我的偏好",
    ...
    OnlineCaseExpectation(
        ...
        expected_safety="SAFE",
        expected_status="EXECUTED",
        required_trace_tools=("route.plan", "provider.map.route"),
        route_max_km=10,
    ),
)
